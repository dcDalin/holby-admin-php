$("#btn-delete-blog").click(function() {
  swal({
    title: "Are you sure?",
    text: "Category and its Sub Categories will be deleted",
    type: "warning",
    ...
    preConfirm: function() {
      return new Promise(function(resolve) {
        $.ajax({
          url: "ajax/category-delete-ajax.php",
          type: "POST",
          dataType: "json"
        })
          .done(function(data) {
            ...
            setTimeout(function() {
              if (data.status === "success") {
                $("#btn-delete-blog").html(
                  '<img src="ajax-loader.gif" style="margin: auto; width:10%;"> &nbsp; Deleting...'
                );
                setTimeout(' window.location.href = "category-view"; ', 3000);
              } else {
                $("#btn-delete-blog").html(
