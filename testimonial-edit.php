...
<?php 
  if(isset($_GET['id']) && !empty($_GET['id'])){
    ...
    $result = $common -> GetRows("
      SELECT * FROM tbl_testimonials WHERE id='".$id."'
    ");
...
<head>
  ...
  <title>
    <?php echo $SystemName; ?> | Edit | Delete Testimonial
  </title>
  <?php 
...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Edit | Delete Testimonial</h3>
            <div class="box-tools pull-right">
              <?php 
                $_SESSION['testimonialId'] = $id;
                $_SESSION['testimonialThumbnail'] = $thumbnail;
              ?>
            ...
            <form method="post" enctype="multipart/form-data" id="edit-slider-form">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <input type="hidden" name="testimonialId" value="<?php echo $id; ?>" />
                  <input type="hidden" name="testimonialThumbnail" value="<?php echo $thumbnail; ?>" />

                  <div class="col-md-12">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>Current Slider Image</label>
                        <img src="uploads/testimonial_images/<?php echo $thumbnail; ?>" height="200px" width="400px" />
                      </div>
                    </div>
                  </div>
  ...
  <script type="text/javascript" src="ajax-js/testimonial-edit.js"></script>
  <script type="text/javascript" src="ajax-js/testimonial-delete.js"></script>
