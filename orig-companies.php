...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" placeholder="Company Logo" name="companyLogo" id="companyLogo">
                    ...
                    <div class="box-body">
                        ...
                        <table id="table"
                            ...
                            <tr>
                                ...
                                <th data-field="companyEmail">COmpany Email</th>
                                <th data-field="companyPhoneNumber">Phone Number</th>
                                <th data-field="companyWebsite">Website URL</th>
        ...
        <script type="text/javascript" src="bootstrap-tables/bootstrap-table.min.js"></script>

        <!-- Bootstrap Table Pagination Params Starts -->
        <script>
        ...
        <!-- Bootstrap Table Pagination Params Ends -->
