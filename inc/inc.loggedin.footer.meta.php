        ...
        return new Promise(function(resolve) {
          ...
          $.ajax({
            ...
            .done(function(data) {
              ...
              $("#wrapper-logout").html(
                '<h5>Saving... <img src="ajax-loader.gif" style="margin: auto; width:30px;"></h5>'
              );
              setTimeout(function() {
                if (data.status === 'success') {
                  $("#wrapper-logout").html(
                    '<h5>Logging out... <img src="ajax-loader.gif" style="margin: auto; width:30px;"></h5>'
                  );
                  setTimeout(' window.location.href = "index"; ', 3000);
                } else {
                  $("#wrapper-logout").html(
                    '<h5>Failed... <img src="ajax-loader.gif" style="margin: auto; width:30px;"></h5>'
                  );
